...
\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-dYWgzL/figureC9eccJ.png}
\end{center}

\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-dYWgzL/figureDAEiyJ.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-dYWgzL/figureGJVlrK.png}
\end{center}

\subsubsection{Post-ANOVA+Refit Response Vector Distance}
\label{sec:orgec1cd30}
\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-dYWgzL/figureFZD2Zn.png}
\end{center}

\begin{center}
\includegraphics[width=.9\linewidth]{/tmp/babel-dYWgzL/figureMU3lr1.png}
\end{center}
\end{document}
