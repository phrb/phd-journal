...
test = [s for s in product(repeat([factor_names], inner = length(factor_names))...)]
test = sort([sort(t) for t in test])
...
27-element Array{Tuple{Symbol,Symbol,Symbol},1}:
 (:A, :A, :A)
 (:B, :A, :A)
 (:C, :A, :A)
 (:A, :B, :A)
 ...
 (:B, :C, :C)
 (:C, :C, :C)
ERROR: MethodError: no method matching sort(::Tuple{Symbol,Symbol,Symbol})
Closest candidates are:
  sort(!Matched::AbstractUnitRange) at range.jl:842
  sort(!Matched::Range) at range.jl:845
  sort(!Matched::SparseVector{Tv,Ti}; kws...) where {Tv, Ti} at sparse/sparsevector.jl:1878
  ...
Stacktrace:
 [1] collect(::Base.Generator{Array{Tuple{Symbol,Symbol,Symbol},1},Base.#sort}) at ./array.jl:475
