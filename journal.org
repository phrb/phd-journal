...
#+TAGS: Book(b) DOE(D) Code(C) NODAL(N) FPGA(F) Autotuning(A)
...
Then, export the directory to the =repository_dir= variable:
...
- Benchmark transformed code to find the best version
  ...
  - Hardware counters:
    ...
    - Total CPU cycles
**** Attempts at PCA ([[Analysing FPGA Autotuning Samples][Main Section]])               :R:Code:FPGA:Autotuning:
Make sure you have the data:
#+BEGIN_SRC sh
git clone https://github.com/phrb/legup-tuner.git
#+END_SRC
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure8765GtO.png]]
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure8765hJW.png]]
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure87657rK.png]]
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure8765vNv.png]]
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure87658X1.png]]
...
#+RESULTS:
[[file:/tmp/babel-8765Jw8/figure8765uhE.png]]
...
**** More Attempts at Correlations
***** Setup
Make sure you have the data:

#+BEGIN_SRC sh
git clone https://github.com/phrb/legup-tuner.git
cd legup-tuner && git pull
#+END_SRC
