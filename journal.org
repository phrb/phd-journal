...
**** Plotting Orio Experiments Data (atax, O2, quadratic terms, xeon e5)
#+HEADER: :results output
#+BEGIN_SRC shell
...
**** Plotting Orio Experiments Data (atax, O2, quadratic terms, xeon e3 12)
#+HEADER: :results output
#+BEGIN_SRC shell
git clone https://github.com/phrb/orio_experiments.git || (cd orio_experiments && git pull)
#+END_SRC
...
#+end_example
*** [2018-07-17 Tue]
**** Plotting atax0 O2 Uniform + D-Optimal Sampling
#+HEADER: :results output :session *R*
#+BEGIN_SRC R
library(ggplot2)
...
*** [2018-07-18 Wed]
**** Plotting atax1 O3 Random Uniform Sample
#+HEADER: :results output :session *R*
#+BEGIN_SRC R
library(ggplot2)
...
#+RESULTS:
#+begin_example
'data.frame':	729 obs. of  26 variables:
...
ggplot(data) +
    ...
    geom_text(aes(x = cost_mean + 0.03, y = 125, label = "-O3 baseline"), data = O3_baseline) +
    theme_bw()
#+END_SRC

#+RESULTS:
[[file:/tmp/babel-XqTCQN/figureGlddsS.png]]
