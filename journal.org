...
*** Creating a Data Frame for FPGA Autotuning Samples
Following Arnaud's [[https://github.com/alegrand/SMPE#learning-r][guidelines]] from the SMPE course.
...
data <- read.table("~/code/legup-tuner/post_place_and_route/py/results/default_stratixV_perf/dfdiv_5400_1/best_block_log.txt",
                   header = FALSE)
#+END_SRC
...
The slides and code are hosted at [[https://github.com/alegrand/SMPE][GitHub]].
