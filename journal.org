...
regression = stepAIC(null, scope = list(upper = full), direction = "both", trace = 0)
...
#+begin_example
            Df Sum Sq Mean Sq F value   Pr(>F)
x2           1 626013  626013 456.819  < 2e-16 ***
x4           1 472662  472662 344.915  < 2e-16 ***
x1           1 137668  137668 100.460  < 2e-16 ***
x5           1  69582   69582  50.776 2.08e-10 ***
I(1/x3)      1  10407   10407   7.594  0.00703 **
Residuals   94 128815    1370
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + I(1/x2) + I(1/x3)
y ~ x2 + x4 + x1 + x5 + I(1/x3)
[1] "x2" "x4" "x1" "x5"
#+end_example
