...
***** TODO:
****** DONE Clean the data again
CLOSED: [2017-12-15 Fri 15:17]
:LOGBOOK:
- State "DONE"       from              [2017-12-15 Fri 15:17]
:END:
- remove metrics with only one value (LUs) linked metrics (Blocks
  and RAM) and probably even binary metrics as it does not fit really well in a
  multicriteria optimization framework
...
****** DONE Characterize the Pareto Border
CLOSED: [2017-12-15 Fri 15:19]
:LOGBOOK:
- State "DONE"       from              [2017-12-15 Fri 15:19]
:END:
For each entry, check wheter there exists an other one which is better on all
metrics. 
****** STARTED Colorize GGpairs with Pareto Border
:LOGBOOK:
- State "STARTED"    from              [2017-12-15 Fri 15:19]
:END:
Then we can colorize our simplfied ggpair with this Pareto-dominated value.
****** STARTED Try to clean data further, but for parameters
:LOGBOOK:
- State "STARTED"    from              [2017-12-15 Fri 15:19]
:END:
...
****** TODO Maybe we could try to reobtain some data.
:LOGBOOK:
- State "TODO"       from              [2017-12-15 Fri 15:20]
:END:
*** [2017-12-14 Thu]
- Configure ~spacemacs~
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401_6H.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401OHc.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401oic.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401bRi.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401OVE.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure24011lu.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure24011zW.png]]
...
#+HEADER: :width 800 :height 600
#+BEGIN_SRC R
data <- load_data("sha", experiments)
plot_uniques(c(1:26), data)
#+END_SRC

#+RESULTS:
[[file:/tmp/babel-2401hm4/figure24013KB.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401r6N.png]]
...
data <- load_data("dfsin", experiments)
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401FPa.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401fjm.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure240153y.png]]

Generating a 3D plot:

#+HEADER: :results output :session *R* :exports both
#+BEGIN_SRC R
p <- plot_ly(pareto, x = ~MKS, y = ~Regs, z = ~DPS, color = ~(.level == 1), colors = "Set1") %>%
     add_markers() %>%
     layout(scene = list(xaxis = list(title = 'MKS'),
                         yaxis = list(title = 'Regs'),
                         zaxis = list(title = 'DSP')))
...
***** Tasks
1) Plot the default configuration (starting point)
   in a different color
2) Look at the behaviour of the other applications:
   - Are there two or three metrics to optimize, like
     in the "dfdiv" application, or there are more?
3) Are only one or two parameters responsible for the
   points in the Pareto Border?
