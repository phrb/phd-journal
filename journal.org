...
def dopt_anova_step(response, factors, inverse_factors, data, fixed_factors, budget):
    ...
    if budget - len(data[0]) < 0:
        ...
        heteroscedasticity_test = car.ncvTest(stats.lm(Formula(lm_formula), data = design))
        print("Heteroscedasticity Test p-value:")
        print(heteroscedasticity_test.rx("p")[0][0])

        if heteroscedasticity_test.rx("p")[0][0] < 0.05:
            design, transform_lm_formula = transform_design(design, lm_formula,
                                                            full_model, response)
...
Regression Step:
                        Df   Sum Sq  Mean Sq F value  Pr(>F)
elements_number          1 0.000129 0.000129   1.318 0.27337
y_component_number       1 0.000136 0.000136   1.393 0.26084
vector_length            1 0.001178 0.001178  12.081 0.00458 **
temporary_size           1 0.000050 0.000050   0.513 0.48736
load_overlap             1 0.000001 0.000001   0.006 0.93856
threads_number           1 0.000002 0.000002   0.018 0.89671
lws_y                    1 0.003902 0.003902  40.007 3.8e-05 ***
I(1/y_component_number)  1 0.000028 0.000028   0.287 0.60185
I(1/lws_y)               1 0.000894 0.000894   9.167 0.01051 *
I(1/elements_number)     1 0.000031 0.000031   0.322 0.58090
I(1/threads_number)      1 0.000147 0.000147   1.512 0.24238
Residuals               12 0.001170 0.000098
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Identical predictions (tol = 1e-17): 1
Fixed Variables: {'lws_y': 128, 'vector_length': 4}
Dimensions of Pruned Data: [1] 384   8

Fixed Factors: {'lws_y': 128, 'vector_length': 4}
Slowdown: 4.84106670713802
Budget: 24/58
Full data does not fit on budget
Computing D-Optimal Design
Heteroscedasticity Test p-value:
...
Regression Step:
                        Df    Sum Sq   Mean Sq F value  Pr(>F)
elements_number          1 5.891e-17 5.891e-17   7.685 0.02168 *
y_component_number       1 4.130e-18 4.130e-18   0.539 0.48142
temporary_size           1 1.157e-17 1.157e-17   1.509 0.25050
load_overlap             1 1.000e-19 1.000e-19   0.013 0.91215
threads_number           1 1.418e-16 1.418e-16  18.490 0.00199 **
I(1/y_component_number)  1 7.200e-19 7.200e-19   0.093 0.76680
I(1/elements_number)     1 8.386e-17 8.386e-17  10.939 0.00912 **
I(1/threads_number)      1 3.065e-17 3.065e-17   3.998 0.07663 .
Residuals                9 6.899e-17 7.670e-18
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Identical predictions (tol = 1e-17): 1
Fixed Variables: {'lws_y': 128, 'vector_length': 4, 'threads_number': 256, 'elements_number': 12}
Dimensions of Pruned Data: [1] 12  8

Fixed Factors: {'lws_y': 128, 'vector_length': 4, 'threads_number': 256, 'elements_number': 12}
Slowdown: 12.250258645798533
Budget: 42/58
Full data fits on budget, picking best value
Fixed Factors: {'lws_y': 128, 'vector_length': 4, 'threads_number': 256, 'elements_number': 12}
Slowdown: 12.230545595782589
Budget: 54/58
#+end_example
