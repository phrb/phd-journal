...
#+BEGIN_SRC R
library(ggplot2)
data <- read.csv("orio_experiments/testsuite/SPAPT/dgemv3/xeon_e3_1230_v2/dgemv1/search_space.csv")
...
#+RESULTS:
[[file:/tmp/babel-Zspy18/figureynmmvV.png]]
*** [2018-07-23 Mon]
...
#+begin_example
[1] 1799   37
'data.frame':	1796 obs. of  37 variables:
...
'data.frame':	1 obs. of  37 variables:
 ...
 $ T2_Ja                       : int 1
 $ U2_I                        : int 1
 $ mean_confidence_interval_inf: num 0.0721
 $ T1_I                        : int 1
 $ T1_J                        : int 1
 $ T1_K                        : int 1
 ...
 $ SCR                         : Factor w/ 2 levels "False","True": 1
 $ T1_Ia                       : int 1
 $ T1_Ka                       : int 1
 $ OMP1                        : Factor w/ 2 levels "False","True": 1
 $ U1_K                        : int 1
 $ U1_J                        : int 1
 $ U1_I                        : int 1
 $ T2_Ka                       : int 1
 ...
 $ U2_J                        : int 1
 $ U2_K                        : int 1
 $ cost_mean                   : num 0.0736
 $ RT2_K                       : int 1
 $ OMP2                        : Factor w/ 2 levels "False","True": 1
 $ cost_std                    : num 0.0047
 $ correct_result              : Factor w/ 2 levels "False","True": 2
 $ mean_confidence_interval_sup: num 0.0752
#+end_example
...
ggplot(data) +
    geom_histogram(aes(cost_mean), binwidth = 0.01) +
    geom_vline(aes(xintercept = cost_mean), O3_baseline, color = "black", linetype = 2) +
    coord_cartesian(xlim = c(0, max(data$cost_mean)), ylim = c(0, 90)) +
    geom_text(aes(x = cost_mean + 0.05, y = 90, label = "-O3 baseline"), data = O3_baseline) +
    theme_bw()
#+END_SRC

#+RESULTS:
[[file:/tmp/babel-Zspy18/figureg6RFXq.png]]
