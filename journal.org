...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401aXP.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401PIj.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure24012tp.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401PWL.png]]
...
#+RESULTS:
[[file:/tmp/babel-2401hm4/figure2401pxL.png]]
...
p <- plot_ly(pareto, x = ~MKS, y = ~Regs, z = ~DPS, color = ~factor(.level)) %>%
     add_markers() %>%
     layout(scene = list(xaxis = list(title = 'MKS'),
                         yaxis = list(title = 'Regs'),
                         zaxis = list(title = 'DSP')))
...
- PGMPITuneLib:
  ...
  - Repository in [[github.com/hunsa][GitHub]]
