...
**** Plotting More Correlations ([[More Attempts at Correlations][Continued from Here]])
***** Setup
Make sure you have the data:
...
1               set_parameter.MULTIPUMPING            Pins
2                                   Blocks             RAM
**** Discussions with Arnaud and Brice
- Read Steven's reports: https://hal.inria.fr/hal-01579422
