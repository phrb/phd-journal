...
#+BEGIN_SRC R
removed <- c("WNS", "Blocks", "RAM", "LUs", "Pins", "Cycles", "FMax")
data <- load_data("sha", experiments, removed)
plot_uniques(c(1:26), data)
#+END_SRC

#+RESULTS:
[[file:/tmp/babel-8816rvR/figure8816xqu.png]]
...
#+RESULTS:
[[file:/tmp/babel-8816rvR/figure8816knc.png]]
...
#+RESULTS:
[[file:/tmp/babel-8816rvR/figure8816S3Y.png]]
