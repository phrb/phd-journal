...
*Objective*: write simple test functions for comparing different experimental
designs in a setting restricted to a budget of point evaluations.
...
0.0
  ...
  0.000005 seconds (9 allocations: 368 bytes)
0.0
...
0.0
  ...
  0.000004 seconds (9 allocations: 512 bytes)
0.0
#+end_example
